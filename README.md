...
<p align="center">
  <img src="./examples/solo-agent-slide.png" width="49%" alt="单独的小人作为透明插画，配合页面中的模型继承关系图">
  <img src="./examples/object-only-slide.png" width="49%" alt="放大镜、文件夹和剪刀等无角色的透明物件插画，配合页面中的任务前后对照">
</p>

左图只生成戴眼镜的小人；右图分别生成找文件夹和剪去杂乱纸条的物件。两页中的标题、说明和连线由演示稿排版，插画本身保持透明、无文字。
